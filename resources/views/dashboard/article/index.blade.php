                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-zinc-800">
                            @foreach ($articles as $article)
                                <tr class="hover:bg-gray-50 transition-colors duration-150 dark:hover:bg-zinc-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <button data-modal-target="deleteModal-{{ $article->id }}"
                                ...
                                <div id="deleteModal-{{ $article->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div
                                            ...
                                            <p class="mb-4 text-gray-500 dark:text-gray-300">
                                                Apakah anda yakin ingin menghapus <b>{{ $article->title }}</b> ?
                                            </p>

                                            <!-- Buttons -->
                                            <div class="flex justify-center items-center space-x-4">
                                                <button data-modal-toggle="deleteModal-{{ $article->id }}"
                                                    type="button"
                                                ...
                                                <form action="/dashboard/articles/{{ $article->slug }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
