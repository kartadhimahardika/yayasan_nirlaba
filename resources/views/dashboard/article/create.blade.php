<x-app-layout>
    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-zinc-800">
        ...
        <!-- Modal body -->
        <form action="/dashboard/articles" method="POST" class="p-4 md:p-5" enctype="multipart/form-data"
            id="article-form">
            @csrf
            <div class="mb-4 col-span-2">
                ...
                <input type="text" name="title" id="title"
                    ...
                    placeholder="Tulis judul artikel" autofocus autocomplete="off" value="{{ old('title') }}">
                @error('title')
            ...
            <div class="mb-6 col-span-2">
                ...
                <textarea id="description" rows="4" name="description"
                    ...
                    placeholder="Tulis deskripsi artikel disini">{{ old('description') }}</textarea>
                <div id="editor"></div>
                @error('description')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                </div>
