                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150 dark:hover:bg-zinc-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <button
                                                class="inline-flex items-center px-3 py-1.5 text-xs rounded-md border bg-white text-red-700 hover:bg-red-50 border-red-300 dark:bg-zinc-800 dark:text-red-400 dark:border-red-500 dark:hover:bg-zinc-700">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
