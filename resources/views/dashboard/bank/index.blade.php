                        ...
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" name="keyword"
                                    ...
                                    placeholder="Cari nama pemilik" autocomplete="off">
                            </div>
                        </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-zinc-800">
                            @foreach ($banks as $bank)
                                <tr class="hover:bg-gray-50 transition-colors duration-150 dark:hover:bg-zinc-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <button data-modal-target="deleteModal-{{ $bank->id }}"
                                                data-modal-toggle="deleteModal-{{ $bank->id }}"
                                ...
                                <!-- Delete Modal -->
                                <div id="deleteModal-{{ $bank->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div
                                            ...
                                            <p class="mb-4 text-gray-500 dark:text-gray-300">
                                                Apakah anda yakin ingin menghapus no. rekening
                                                <b>{{ $bank->holder }}</b> ?
                                            </p>

                                            <!-- Buttons -->
                                            <div class="flex justify-center items-center space-x-4">
                                                <button data-modal-toggle="deleteModal-{{ $bank->id }}"
                                                    type="button"
